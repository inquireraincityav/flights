...
# --- Itinerary ---
MAX_STOPS: int = _int("MAX_STOPS", 2)
MAX_PREFERRED_DURATION_HOURS: int = _int("MAX_PREFERRED_DURATION_HOURS", 30)
MAX_PREFERRED_LAYOVER_HOURS: int = _int("MAX_PREFERRED_LAYOVER_HOURS", 12)
MIN_CONNECTION_MINUTES: int = _int("MIN_CONNECTION_MINUTES", 75)
...
SCORE_WEIGHT_PRICE: float = _float("SCORE_WEIGHT_PRICE", 0.45)
SCORE_WEIGHT_STOPS: float = _float("SCORE_WEIGHT_STOPS", 0.15)
SCORE_WEIGHT_DURATION: float = _float("SCORE_WEIGHT_DURATION", 0.10)
SCORE_WEIGHT_BAGGAGE: float = _float("SCORE_WEIGHT_BAGGAGE", 0.10)
SCORE_WEIGHT_DIRECT_BOOKING: float = _float("SCORE_WEIGHT_DIRECT_BOOKING", 0.10)
